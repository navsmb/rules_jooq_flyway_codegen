...
some other ruleset that depends on rules_jooq_flyway_codegen, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_jooq_flyway_codegen=$(pwd)/rules_jooq_flyway_codegen"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_jooq_flyway_codegen` on your system will point to this folder.
...
https://github.com/navsmb/rules_jooq_flyway_codegen/actions/workflows/tag.yaml
